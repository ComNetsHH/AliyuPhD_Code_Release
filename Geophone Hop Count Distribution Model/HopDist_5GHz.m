...
transmittedPower = 25e-3;    % Transmitted power in watts (25mW)
...
%***********************************************************
HD_Tx25mW_5ghz_sim = Hop_25mW_simvsmodel_650m{:,1}; %obtained from simulation saved as matlab table
HD_Tx25mW_5ghz_model = Hop_25mW_simvsmodel_650m{:,2}; %obtained analytically based on number of nodes that fall between R,2R,3R...

%plot
distributionFitter(HD_Tx25mW_5ghz_model);hold on;
distributionFitter(HD_Tx25mW_5ghz_sim);
hold off